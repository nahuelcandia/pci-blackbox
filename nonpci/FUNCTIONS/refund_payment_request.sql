...
GRANT  ALL ON FUNCTION Refund_Payment_Request(_PSP text, _MerchantAccount text, _URL text, _Username text, _Password text, _CurrencyCode char(3), _PaymentAmount numeric, _PSPReference text) TO GROUP nonpci_api;
